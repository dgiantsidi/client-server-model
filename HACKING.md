...
hidden if the `clt-svr-model_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `clt-svr-model_DEVELOPER_MODE` to the configure
